...
interface ArticleDetailClientProps {
  slug: string;
  // Sunucuda çekilen yayındaki makale; taslak/onay bekleyen makalelerde null
  // gelir ve veri istemcideki API çağrısıyla (oturum yetkisine göre) yüklenir.
  initialArticle?: any;
}
...
export default function ArticleDetailClient({
  ...
  // Makaleyi getirme — initialArticle olsa da çağrılır: görüntülenme sayacı
  // API tarafında arttığı için ve beğeni/görüntülenme sayılarının tazesi gelsin diye.
  useEffect(() => {
    if (!slug) {
