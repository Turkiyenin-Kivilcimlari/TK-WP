  ...
  try {
    ...
    if (!application) {
      return encryptedJson(
        {
          success: false,
          message: "Başvuru bulunamadı veya görüntüleme yetkiniz yok",
        },
        { status: 404 }
      );
    }
      ...
      return encryptedJson(
        {
          success: false,
          message:
            "Başvuru bulunamadı veya bu başvuruyu güncelleme yetkiniz yok",
        },
        { status: 404 }
      );
    }
  ...
  try {
    ...
    if (!application) {
      return encryptedJson(
        {
          success: false,
          message: "Başvuru bulunamadı veya bu başvuruyu silme yetkiniz yok",
        },
        { status: 404 }
      );
    }
