...
interface EventDetailClientProps {
  slug: string;
  // Sunucuda çekilen onaylı etkinlik (participants içermez); onaylı olmayan
  // etkinliklerde null gelir ve veri istemcideki API çağrısıyla yüklenir.
  initialEvent?: any;
}
...
export default function EventDetailClient({
  ...
  // initialEvent olsa da API'den taze veri çekilir: katılımcı listesi SSR
  // verisinde bulunmadığından kayıt durumu ancak bu çağrıyla netleşir.
  useEffect(() => {
