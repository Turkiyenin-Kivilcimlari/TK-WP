...
export default function AdminSupportersPage() {
  ...
  if (status === "authenticated" && !isTwoFactorLoading && twoFactorStatus) {
    ...
    if (isAdmin && (!twoFactorStatus.enabled || !twoFactorStatus.verified)) {
      redirect("/admin/verify-2fa?returnUrl=/admin/supporters");
      return null;
    }
  }
  ...
  return (
    <div className="container py-8 px-4 max-w-7xl mx-auto">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold mt-4">Topluluk Destekçileri Yönetimi</h1>
        <p className="mt-2 text-muted-foreground">
          Topluluk destekçilerini yönetin, resimlerini ekleyin ve düzenleyin.
        </p>
      </div>
